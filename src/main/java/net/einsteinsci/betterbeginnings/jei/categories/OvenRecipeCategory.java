...
import net.einsteinsci.betterbeginnings.jei.wrappers.JEIOvenRecipeWrapper;
...
public class OvenRecipeCategory implements IRecipeCategory<JEIOvenRecipeWrapper>
{
