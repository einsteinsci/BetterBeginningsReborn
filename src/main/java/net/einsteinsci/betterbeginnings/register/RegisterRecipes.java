    ...
    private static void addCampfireRecipes()
    {
		...
		if (BBConfig.canCampfireDoAllKilnStuff)
		{
		    ...
		    CampfireRecipeHandler.addRecipe(new ItemStack(Blocks.STONEBRICK, 1, 0),
			    new ItemStack(Blocks.STONEBRICK, 1, 2), 0.1f, false);
