...
public class RegisterRecipes {
	...
	private static void addKilnRecipes() {
		...
		KilnConfig.addRecipe(Items.CHICKEN, new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_CHICKEN),
				0.1f);
		KilnConfig.addRecipe(new ItemStack(Items.FISH, 1, 0),
				new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_FISH), 0.1f);
		KilnConfig.addRecipe(new ItemStack(Items.FISH, 1, 1),
				new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_FISH), 0.1f);
		KilnConfig.addRecipe(Items.RABBIT, new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_RABBIT),
				0.1f);
		KilnConfig.addRecipe(Items.MUTTON, new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_MUTTON),
				0.1f);
	}

	private static void addBrickOvenRecipes() {
		BrickOvenConfig.addShapedRecipe(new ItemStack(Items.GOLDEN_APPLE), "GGG", "GAG", "GGG", 'G', Items.GOLD_INGOT,
				'A', Items.APPLE);
		BrickOvenConfig.addShapedRecipe(new ItemStack(Items.GOLDEN_APPLE, 1, 1), "###", "#A#", "###", '#',
				Blocks.GOLD_BLOCK, 'A', Items.APPLE);
		BrickOvenConfig.addShapedRecipe(new ItemStack(Items.CAKE), "MMM", "SES", "WWW", 'M', Items.MILK_BUCKET, 'S',
		...
		BrickOvenConfig.addShapedRecipe(new ItemStack(Items.RABBIT_STEW), " R ", "CPM", " B ", 'R', Items.COOKED_RABBIT,
		...
		BrickOvenConfig.addShapedRecipe(new ItemStack(RegisterItems.marshmallow, 3), " S ", "SSS", " S ", 'S',
				Items.SUGAR);
		...
		BrickOvenConfig.addShapelessRecipe(new ItemStack(Items.COOKED_FISH, 1, 1), new ItemStack(Items.FISH, 1, 1));
		...
		BrickOvenConfig.addShapelessRecipe(new ItemStack(Items.PUMPKIN_PIE), Items.EGG, Items.SUGAR, Blocks.PUMPKIN);
		BrickOvenConfig.addShapelessRecipe(new ItemStack(Items.FERMENTED_SPIDER_EYE), Items.SPIDER_EYE, Items.SUGAR,
				Blocks.BROWN_MUSHROOM);
		BrickOvenConfig.addShapelessRecipe(new ItemStack(Items.MAGMA_CREAM), Items.SLIME_BALL, Items.BLAZE_POWDER);
	}
	...
	private static void addSmelterRecipes() {
		...
		if (BBConfig.canSmelterDoKilnStuff) {
			SmelterConfig.addRecipe(new ItemStack(Blocks.SAND, 1, 0), new ItemStack(Blocks.GLASS), 0.1f, 1, 0);
			SmelterConfig.addRecipe(new ItemStack(Blocks.SAND, 1, 1), new ItemStack(Blocks.STAINED_GLASS, 1, 1), 0.1f,
			...
			SmelterConfig.addRecipe(new ItemStack(Blocks.SPONGE, 1, 1), new ItemStack(Blocks.SPONGE, 1, 0), 0.1f, 0, 0);
			SmelterConfig.addRecipe(new ItemStack(Blocks.STONEBRICK, 1, 0), new ItemStack(Blocks.STONEBRICK, 1, 2),
					0.1f, 0, 0);
		}
	...
	private static void addCampfireRecipes() {
		...
		CampfireConfig.addRecipe(Items.CHICKEN,
				new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_CHICKEN), 0.1f);
		CampfireConfig.addRecipe(new ItemStack(Items.FISH, 1, 0),
				new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_FISH), 0.1f);
		CampfireConfig.addRecipe(new ItemStack(Items.FISH, 1, 1),
				new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_FISH), 0.1f);
		CampfireConfig.addRecipe(Items.RABBIT, new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_RABBIT),
				0.1f);
		CampfireConfig.addRecipe(Items.MUTTON, new ItemStack(RegisterItems.charredMeat, 1, ItemCharredMeat.META_MUTTON),
				0.1f);
		...
		if (BBConfig.canCampfireDoAllKilnStuff) {
			...
			CampfireConfig.addRecipe(new ItemStack(Blocks.STONEBRICK, 1, 0), new ItemStack(Blocks.STONEBRICK, 1, 2),
					0.1f);
	...
	public static void addAdvancedRecipes() {
		...
		if (BBConfig.advancedCraftingForLotsOfThings) {
			...
			// Iron Door
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Items.IRON_DOOR), new Object[] { "nuggetIron", 2 },
			...
			// Piston
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.PISTON), new Object[] { "nuggetIron", 2 },
					"###", "CIC", "CRC", '#', "plankWood", 'I', "ingotIron", 'C', "cobblestone", 'R', "dustRedstone");
			// Dispenser
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.DISPENSER), new Object[] { "nuggetIron", 2 },
					"###", "#B#", "#R#", '#', "cobblestone", 'B', new ItemStack(Items.BOW, 1, 0), 'R', "dustRedstone");
			// Note Block
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.NOTEBLOCK), new Object[] { "itemString", 2 },
			...
			// TNT
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.TNT, 2), new Object[] { "itemString", 3 },
					"G#G", "#G#", "G#G", 'G', Items.GUNPOWDER, '#', Blocks.SAND);
			// Bookshelf
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.BOOKSHELF), new Object[] { "nuggetIron", 1 },
					"###", "BBB", "###", '#', "plankWood", 'B', Items.BOOK);
			// Ladder
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.LADDER, 4), new Object[] { "itemString", 1 },
					"/ /", "///", "/ /", '/', "stickWood");
			// Rail
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.RAIL, 16), new Object[] { "nuggetIron", 1 },
			...
			// Hopper
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.HOPPER, 4),
			...
			// Dropper
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Blocks.DROPPER), new Object[] { "nuggetIron", 2 },
			...
			// Item Frame
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Items.ITEM_FRAME), new Object[] { "itemString", 1 },
			...
			// Armor Stand
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Items.ARMOR_STAND), new Object[] { "nuggetIron", 2 },
		...
		// Shears
		AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Items.SHEARS), new Object[] { "nuggetIron", 1 }, " I",
				"I ", 'I', "ingotIron");
		...
		if (BBConfig.allowStringAsToolBinding) {
			...
			AdvancedCraftingConfig.addAdvancedRecipe(new ItemStack(Items.BOW), new Object[] { "itemStringTough", 6 },
		...
		// Gold armor
		AdvancedCraftingConfig.addAdvancedRecipe(
