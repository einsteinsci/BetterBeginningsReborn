...
public class RegisterHelper
{
    ...
    {
    if(!name.toLowerCase().equals(name)) throw new IllegalArgumentException(name + " contains non-lowercase characters. Registry names should be lowercase in preparation for 1.11");
    ...
    public static void registerBlock(Block block, String name)
    {
        ...
        GameRegistry.register(block); // TODO: Replace with Forge registry event?
