...
public class BoosterConfig implements IJsonConfig
{
	...
	public void loadJsonConfig(FMLInitializationEvent e, String mainJson, String autoJson, String customJson)
	{
		...
		if(mainBoosters.getActualVersion() < getPackagedVersion() && BBConfig.autoRegenJsons)
		{
			LogUtil.log(Level.INFO, "Boosters are outdated. main.json will be regenerated");
			mainBoosters = initialAssociations;
			mainBoosters.updateVersion(getPackagedVersion());
		}
