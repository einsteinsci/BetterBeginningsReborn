...
public abstract class ItemKnife extends ItemTool implements IBBName
{
	...
	private static final IItemPropertyGetter thrownGetter = new IItemPropertyGetter()
	    {
		@Override
		public float apply(ItemStack stack, World worldIn, EntityLivingBase entityIn)
		{
		    return entityIn != null && isThrown(stack) ? 1.0F : 0.0F;
		}
	    };
	...
	{
	    	if(isThrown(stack)) return super.onItemRightClick(stack, world, player, hand);
