...
public class ItemWickerShield extends ItemShield implements IBBName
{
	...
	private void doAxeStuff(EntityLivingBase attacked, EntityLivingBase attacker) 
	{
		...
		if (itemstack != null && itemstack1 != null && itemstack.getItem() instanceof ItemAxe && itemstack1.getItem() == RegisterItems.wickerShield)
		{
	...
	void damageShield(EntityLivingBase attacked, EntityLivingBase attacker, float f)
	{
		...
		{
		    attacked.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, (ItemStack)null);
		}
		else
		{
		    attacked.setItemStackToSlot(EntityEquipmentSlot.OFFHAND, (ItemStack)null);
		}
